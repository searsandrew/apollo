...
class RolesAndPermissionsSeeder extends Seeder
{
    ...
    {
        // api, company, customer, dashboard, flier, file, instruction, inventory, invoice, item, landing, lead, log, masquerade, msrp, order, page, permission, price, rebate, report, setting, user
        return [
            'admin' => ['view api', 'create api', 'delete api', 'view company', 'edit company', 'view customer', 'create customer', 'edit customer', 'delete customer', 'view dashboard', 'view flier', 'create flier', 'edit flier', 'delete flier', 'view file', 'create file', 'delete file', 'view instruction', 'create instruction', 'edit instruction', 'delete instruction', 'view inventory', 'view invoice', 'view item', 'view landing', 'create landing', 'edit landing', 'delete landing', 'view lead', 'edit lead', 'delete lead', 'view log', 'view masquerade', 'view msrp', 'create msrp', 'edit msrp', 'delete msrp', 'view order', 'create order', 'edit order', 'delete order', 'view page', 'create page', 'edit page', 'delete page', 'view permission', 'edit permission', 'delete permission', 'view price', 'view rebate', 'view report', 'create report', 'edit report', 'delete report', 'view setting', 'edit setting', 'view user', 'create user', 'edit user', 'delete user'],
            'regionalManager' => ['view api', 'create api', 'delete api', 'view company', 'edit company', 'view customer', 'create customer', 'edit customer', 'delete customer', 'view dashboard', 'view flier', 'create flier', 'edit flier', 'delete flier', 'view file', 'create file', 'delete file', 'view instruction', 'view inventory', 'view invoice', 'view item', 'view landing', 'create landing', 'edit landing', 'delete landing', 'view lead', 'edit lead', 'delete lead', 'view log', 'view masquerade', 'view msrp', 'create msrp', 'edit msrp', 'delete msrp', 'view order', 'create order', 'edit order', 'delete order', 'view page', 'view price', 'view permission', 'view rebate', 'view report', 'create report', 'edit report', 'delete report', 'view setting', 'view user', 'create user', 'edit user'],
            'salesRep' => ['view api', 'create api', 'delete api', 'view company', 'view customer', 'create customer', 'edit customer', 'delete customer', 'view dashboard', 'view flier', 'create flier', 'edit flier', 'delete flier', 'view file', 'create file', 'delete file', 'view instruction', 'view inventory', 'view invoice', 'view item', 'view landing', 'create landing', 'edit landing', 'delete landing', 'view lead', 'view log', 'view msrp', 'create msrp', 'edit msrp', 'delete msrp', 'view order', 'create order', 'edit order', 'delete order', 'view page', 'view price', 'view rebate', 'view report', 'create report', 'edit report', 'delete report', 'view user', 'edit user'],
            'customerService' => ['view api', 'create api', 'delete api', 'view company', 'view customer', 'create customer', 'edit customer', 'delete customer', 'view dashboard', 'view flier', 'create flier', 'edit flier', 'delete flier', 'view file', 'create file', 'delete file', 'view instruction', 'edit instruction', 'view inventory', 'view invoice', 'view item', 'view landing', 'create landing', 'edit landing', 'delete landing', 'view log', 'view msrp', 'create msrp', 'edit msrp', 'delete msrp', 'view order', 'create order', 'edit order', 'delete order', 'view page', 'edit page', 'view price', 'view rebate', 'view report', 'create report', 'edit report', 'delete report', 'view user', 'create user', 'edit user', 'delete user'],
